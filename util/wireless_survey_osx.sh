...
wireless_data=$(/System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport -s
)

# Create post data string
post_data="os=mac os x&data=$(echo "$wireless_data" | base64)"
